        ...
        <div className='max-w-7xl md:w-[90%] mx-auto bg-white p-4 shadow-md rounded-xl flex justify-center items-center'>
          <form action="" className='p-4 rounded-md shadow-md max-w-md'>
            <div className='flex justify-center items-center'>
                <img src={`http://localhost:5000/images/`+ profile.image_p}   alt="" className='h-[100px] w-[100px] mb-2 rounded-full'/>
            </div>
            ...
            <input type="file" name='image_p' id='image' className='p-2 rounded-md border w-full'/>
